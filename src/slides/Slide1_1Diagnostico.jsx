  ...
  return (
    ...
    >
      ...
      <div className="font-hand text-ink text-lg leading-snug pl-2">
        <EditableText value={value} onChange={onChange} multiline  positionKey="el-1" sizeKey="el-1"/>
      </div>
    </motion.div>
  )
}
      ...
      <div className="grid grid-cols-12 gap-6 flex-1 min-h-0">
        ...
        >
          ...
          <div className="text-[13px] text-muted leading-relaxed">
            <EditableText value={d.diagnostico} onChange={(v) => set({ diagnostico: v })} multiline  positionKey="diagnostico" sizeKey="diagnostico"/>
          </div>
        ...
        >
          ...
          <div className="text-[13px] text-muted leading-relaxed">
            <EditableText value={d.teoria} onChange={(v) => set({ teoria: v })} multiline  positionKey="teoria" sizeKey="teoria"/>
          </div>
        </motion.div>
        ...
        <div className="col-span-4 relative">
          <div className="absolute" style={{ left: '5%', top: '5%' }}>
            <Polaroid
              ...
              delay={0.3}
              zIndex={1}
             positionKey="image1" sizeKey="image1"/>
          </div>
          <div className="absolute" style={{ right: '0%', bottom: '5%' }}>
            <Polaroid
              ...
              delay={0.45}
              zIndex={2}
             positionKey="image2" sizeKey="image2"/>
          </div>
        </div>
      </div>
    </div>
