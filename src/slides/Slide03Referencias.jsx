          ...
          <StaggerItem key={i} y={20}>
            <div className="flex flex-col items-center gap-4">
              <Polaroid
                ...
                height={220}
                delay={0.05 * i}
               positionKey={`image-${i}`} sizeKey={`image-${i}`}/>
              <motion.div
              ...
              >
                <EditableText
                 ...
                 positionKey={`name-${i}`} sizeKey={`name-${i}`}/>
                <div className="font-hand text-wine text-base mt-0.5">
                  <EditableText value={c.place} onChange={(v) => setCard(i, { place: v })}  positionKey={`place-${i}`} sizeKey={`place-${i}`}/>
                </div>
                ...
                <div className="text-[12px] text-muted leading-relaxed mt-3 px-2">
                  <EditableText
                    ...
                    multiline
                   positionKey="description-3" sizeKey="description-3"/>
                </div>
              </motion.div>
            </div>
          </StaggerItem>
